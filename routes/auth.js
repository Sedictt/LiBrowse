...
// Deprecated legacy auto daily login reward endpoint.
// Returns 410 Gone to enforce manual claim via /api/daily-checkin/claim.
router.post('/daily-login-reward', authenticateToken, async (req, res) => {
  return res.status(410).json({
    error: 'Legacy daily login reward removed. Use /api/daily-checkin/claim instead.'
  });
});
